...
// style
import cartModules from "../style/css/cart.module.css";

// file
import trash from "../assets/images/icon/vector.png";

// componentt
import NavBar from "../components/navbar/Navbar";
import { Container } from "react-bootstrap";

export default function CartDigan() {
  const title = "Payment";
  ...
  // cart
  let { data: cart, refetch } = useQuery("cartsCachessss", async () => {
  ...
  const handleSubmit = useMutation(async (e) => {
    try {
      ...
      console.log("SUCCESS ADD DETAIL ADDRESS", response.data.data);
    } catch (err) {
      console.log(err);
    }
  ...
  return (
    <>
      ...
      <Container className={cartModules.container}>
        <section>
